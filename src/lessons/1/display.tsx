    ...
    <div className="bg-gray-700 min-h-screen text-white flex items-center justify-center">
      <div className="max-w-lg">
        ...
        <div className="mt-1 hover:bg-gray-800 hover:bg-opacity-30 px-4 py-1">
          <p className="text-gray-300 pl-14">You can override it in your config if you want but ultimately we chose the defaults they did because they let you get results closest to what a professional designer would do more easily</p>
        </div>
        <div className="mt-1 hover:bg-gray-800 hover:bg-opacity-30 px-4 py-1">
          <p className="text-gray-300 pl-14">Since we changed this in tailwind 2 I've almost never used a leading class at all</p>
        </div>
      </div>
    </div>
  )
