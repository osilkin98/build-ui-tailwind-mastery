  ...
  return (
    <div className="flex text-gray-100 h-screen">
      <div className="bg-gray-900 p-3 space-y-2 overflow-y-scroll">
        ...
        <div className="bg-gray-700 hover:bg-brand hover:text-white text-gray-100 w-12 h-12 rounded-full flex items-center justify-center transition duration-200">
